    ...
    e.prototype = {
        load: function () {
            ...
            var o = t(e.element).next(".ms-options-wrap").find("> button:first-child"),
                ...
                s = i.find("> ul"),
                n = t(e.element).find("optgroup").length ? !0 : !1,
                l = null;
        ...
        loadOptions: function (e, o) {
            o = "boolean" == typeof o ? o : !0;
            var i = this,
                s = t(i.element).next(".ms-options-wrap").find("> .ms-options > ul");
            o && s.find("> li").remove();
            for (var n in e) {
                var l = e[n],
                    a = t("<li></li>");
...
jQuery(document).ready(function (e) {
        e(".rate-circle-static-small40").rateCircle({
            size: 40,
            valuePrefix: ""
        }), e(".rate-circle-static-small").rateCircle({
            size: 45,
            valuePrefix: ""
        }), e(".rate-box-static-small").rateBox(), e(".rate-circle-static-medium").rateCircle({
            size: 80,
            valueSufix: "%"
        }), e(".rate-box-static-medium").rateBox({
            width: 150,
            height: 150,
            valueSufix: "%"
        }), e(".rate-circle-static-small2").rateCircle({
            size: 35,
            fontSize: 11,
            valuePrefix: ""
        }), e(".rate-circle-static-small3").rateCircle({
            size: 50,
            fontSize: 18,
            valuePrefix: ""
        }), e(".rate-box-static-big").rateBox({
            width: 200,
            height: 200,
            valuePrefix: ""
        }), e(".rate-circle").rateCircle({
            size: 100,
            lineWidth: 10,
            fontSize: 10,
            referenceValue: 100,
            ...
            valuePrefix: "",
            valueSufix: ""
        }), e('input[id*="rate-circle"]').on("change mousemove", function () {
            e(".rate-circle").data("value", e("#rate-circle-value").val()), e(".rate-circle").rateCircle({
                size: e("#rate-circle-size").val(),
                lineWidth: e("#rate-circle-line-width").val(),
                fontSize: e("#rate-circle-font-size").val()
            })
        }), e('input[id*="rate-box"]').on("change mousemove", function () {
            e(".rate-box").data("value", e("#rate-box-value").val()), e(".rate-box").rateBox({
                width: e("#rate-box-width").val(),
                height: e("#rate-box-height").val(),
                fontSize: e("#rate-box-font-size").val()
            })
        })
    }),
    function (e) {
        e.fn.rateCircle = function (t) {
            var a = e.extend({
                    size: 10,
                    lineWidth: 6,
                    fontSize: 14,
                ...
                h = a.valuePrefix,
                o = a.valueSufix;
            e(this).html(""), e(this).append(["<canvas class='rate-circle-back' width='" + i + "' height='" + i + "'></canvas>", "<canvas class='rate-circle-front' width='" + i + "' height='" + i + "'></canvas>"]), e(this).css({
                position: "relative",
                display: "block",
                width: i,
                height: i,
                ...
                var t, a = e(this).data("value"),
                    u = e(this).find(".rate-circle-back"),
                    f = u.get(0).getContext("2d");
                t = 10 * a / n, f.lineWidth = c, u.addClass("rate-color-back"), f.strokeStyle = u.css("color"), f.arc(r, r, l, -Math.PI / 180 * 90, 2 * Math.PI - Math.PI / 180 * 90, !1), f.stroke();
                var v = e(this).find(".rate-circle-front"),
                    d = v.get(0).getContext("2d");
                d.lineWidth = c, v.addClass("rate-color" + parseInt(t / 10, 0)), d.strokeStyle = v.css("color");
                var x = Math.PI * t * 2 / 10;
                d.arc(r, r, l, -Math.PI / 180 * 90, x - Math.PI / 180 * 90, !1), d.stroke(), e(this).append("<span class='rate-circle-value'>" + h + a + o + "</span>"), e(this).find(".rate-circle-value").css({
                    "line-height": i + "px",
                    "font-size": s + "px",
                    color: d.strokeStyle
                })
            })
        }, e.fn.rateBox = function (t) {
            var a = e.extend({
                    width: 100,
                    height: 100,
                    fontSize: 30,
                ...
                n = a.valueSufix;
            e(this).each(function () {
                var t, a, h = e(this).data("value");
                a = "rate-gradient" + parseInt(10 * h / c / 10, 0), e(this).html("<div></div>"), (t = e(this).find("div")).addClass(a), t.css({
                    width: i + "px",
                    height: r + "px",
                    margin: "0 auto"
                }), t.append("<span class='rate-box-value'>" + s + h + n + "</span>"), e(this).find(".rate-box-value").css({
                    "font-size": l + "px",
                    height: r + "px",
                    "line-height": r + "px"
                })
